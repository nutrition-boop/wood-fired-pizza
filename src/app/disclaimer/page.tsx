      ...
      <div className="article-layout">
        <main className="article-main">
          <div className="article" id="disclaimer-content">
            ...
            <p>
              The information provided by Wood Fired Pizza Oven ("we," "us," or "our") on www.wood-fired-pizza-oven.us (the "Site") is for general informational purposes only. All information on the Site is provided in good faith, however we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability, or completeness of any information on the Site.
            </p>
            <p>
